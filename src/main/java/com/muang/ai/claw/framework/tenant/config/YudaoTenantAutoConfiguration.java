package com.muang.ai.claw.framework.tenant.config;

import com.muang.ai.claw.framework.common.biz.system.tenant.TenantCommonApi;
import com.muang.ai.claw.framework.common.enums.WebFilterOrderEnum;
import com.muang.ai.claw.framework.mybatis.core.util.MyBatisUtils;
import com.muang.ai.claw.framework.redis.config.YudaoCacheProperties;
import com.muang.ai.claw.framework.security.core.service.SecurityFrameworkService;
import com.muang.ai.claw.framework.tenant.core.aop.TenantIgnore;
import com.muang.ai.claw.framework.tenant.core.aop.TenantIgnoreAspect;
import com.muang.ai.claw.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.muang.ai.claw.framework.tenant.core.job.TenantJobAspect;
import com.muang.ai.claw.framework.tenant.core.redis.TenantRedisCacheManager;
import com.muang.ai.claw.framework.tenant.core.security.TenantSecurityWebFilter;
import com.muang.ai.claw.framework.tenant.core.service.TenantFrameworkService;
import com.muang.ai.claw.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.muang.ai.claw.framework.tenant.core.web.TenantContextWebFilter;
import com.muang.ai.claw.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.muang.ai.claw.framework.web.config.WebProperties;
import com.muang.ai.claw.framework.web.core.handler.GlobalExceptionHandler;
