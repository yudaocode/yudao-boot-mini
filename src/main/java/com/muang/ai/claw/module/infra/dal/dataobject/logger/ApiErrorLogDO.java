package com.muang.ai.claw.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.muang.ai.claw.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
